...
def test_team_members_projects_calendar_connected(mock_org, mock_reg, mock_conn):
    ...
    # looked up by the LOWER-cased email
    mock_conn.assert_any_call('TEN1', 'maya@x.com')
