...
# EMAIL DETAILS BUILDER tests deleted 2026-07-11 — the Bubble-era
# 'EMAIL DETAILS BUILDER' block (humanize_key/format_value/
# build_email_details_text/extract_contact/...) was removed from
# form_handler.py (dead code, zero runtime callers; Bubble deprecated).
