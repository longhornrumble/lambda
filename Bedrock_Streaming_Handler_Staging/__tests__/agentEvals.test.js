...
// ── scripted Bedrock stream builder (extracted, sub-phase 1.2) ─────────────────────────────
// enc/modelTurnEvents/chunkIterator/scriptedBedrock moved to evals/scriptedBedrock.js so
// future eval suites can reuse the canned InvokeModelWithResponseStream sequences.
const { enc, modelTurnEvents, chunkIterator, scriptedBedrock } = require('../evals/scriptedBedrock');
